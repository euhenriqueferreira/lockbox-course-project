        ...
        <div class="border border-stone-700 rounded">
            ...
            <form class="p-4 space-y-4" method="post" action="/livro-criar" enctype="multipart/form-data">
                <?php if($validacoes = flash()->get('validacoes')): ?>    
                    <div class="border-red-800 bg-red-900 text-red-400 px-4 py-2 rounded-md py-1 border-2 text-sm font-bold">
                        <ul>
                            <li>Deu ruim!!</li>
                ...
                <button type="submit" class="border-stone-800 bg-stone-900 text-stone-400 px-4 py-2 rounded-md py-1 border-2 hover:bg-stone-800 transition">Salvar</button>
            </form>
        </div>
    </div>
</div>